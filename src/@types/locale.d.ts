    ...
    "deck": {
      "policies": {
        ...
        "climateChange": {
          ...
          "eventDescription": "CO2 released from human activities results in changes to temperature, rainfall, wind speed and much more, putting additional pressure on the Baltic Sea ecosystem.",
