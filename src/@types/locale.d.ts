interface Resources {
  "translation": {
    ...
    "deck": {
      "policies": {
        ...
        "wasteWaterTreatmentFailure": {
          ...
          "description": "Every player with at least one nutrient card in their row takes a pressure card and places it in their row.",
        ...
        "climateChange": {
          ...
          "stageEventText": "Because of climate change you get an additional impact tile!"
        },
        "oilSpill": {
          "name": "Oil spill",
          "description": "Discard all birds open on the table (in players rows and in the market). Cards in rows are not replaced.",
        ...
        "hazardousIndustrialSubstances": {
          ...
          "description": "Discard all producer cards on the table (in each players rows and in the market). Cards in rows are not replaced.",
          "eventDescription": "Releasing hazardous substances acutely affect plankton, cascading through the rest of the food web."
        },
        "overfishing": {
          "name": "Overfishing",
          "description": "Discard all fish open on the table (in players rows and in the market). Cards in rows are not replaced.",
        ...
        "hunting": {
          "name": "Hunting",
          "description": "Permanently remove all mammals and birds in your row from the game.",
        ...
        "nutrientUpwelling": {
          ...
          "description": "All players take turns (starting from the active player) to add up to two nutrient cards to their row, or until the market is empty.",
        ...
        "excessiveFertilizerUse": {
          ...
          "description": "Add two nutrient card to the active player's row. If there are no more nutrient cards in the market, take a pressure card. Place all oxygen cards in all players rows back in the market.",
        ...
        "upgradedWasteWaterTreatment": {
          ...
          "description": "Take an additional nutrient card from the market or, if you have three nutrient cards in your row, you can put one back in the market.",
        ...
        "migratoryBarrierRemoval": {
          ...
          "description": "Take one fish or bird card from the market and add it to any players row.",
          ...
          "pickPlayerCommandBarText": "Pick a player's row to move your chosen card to"
        },
        "fishingGearRegulation": {
          "name": "Fishing gear regulation",
          "description": "Add all cards in the market which have a mud symbol to any players row.",
          ...
          "commandBarText": "Pick a player's row to move all the mud species to"
        },
        "recyclingAndWasteDisposal": {
          "name": "Recycling and waste disposal",
          "description": "Remove two pressure cards from the row(s) of any player(s) and replace the cards with cards from the player(s) deck(s).",
          ...
          "commandBarText": "Pick a pressure card to discard from any player's row"
        },
        "greenEnergy": {
          "name": "Green energy",
          ...
          "eventDescription": "Green energy development at sea requires space, and the positive and/or negative effects on the ecosystem of the installations depends directly on the quality and timeliness of the planning process.",
          "commandBarText": "Choose either Coast, Rock or Mud habitat to unlock"
        },
        "underwaterNoise": {
    ...
    "stageEventText": {
      ...
      "disaster": "You did not buy anything.\nYou get a pressure card.",
      "extinction": "Too many pressure cards causes an extinction.\nYou get an impact tile and your turn ends.",
      "massExtinction": "Too many pressure cards causes a mass extinction.\nYou get 3 impact tiles and your turn ends.",
      "elementalDisaster": "Too many elements causes a disaster.\nYou get a pressure card and your turn ends.",
    ...
    "abilities": {
      "commandBar": {
        "move": {
          "pickCard": "Pick a card from your row to move",
